...
const NotificationTest = () => {
  ...
  const sendTestNotification = async () => {
    ...
    if (!token) {
      setMessage('Token not found. Please check console.');
      return;
    }
  ...
  return (
    <div className="p-6 bg-slate-900/50 backdrop-blur-md border border-slate-700 rounded-2xl shadow-xl max-w-md mx-auto mt-10">
      <h2 className="text-xl font-bold text-white mb-4">Notification Tester</h2>
      <p className="text-slate-400 mb-6 text-sm">
        Click the button below to send a push notification to this device.
      </p>
